...
class TestSurfaceZLevelGenerator(PathTestUtils.PathTestBase):
    ...
    def _get_test_boundaries(self):
        ...
        border = Part.makeFace(Part.makePolygon([
            FreeCAD.Vector(0,0,0), FreeCAD.Vector(50,0,0), 
            FreeCAD.Vector(50,50,0), FreeCAD.Vector(0,50,0), FreeCAD.Vector(0,0,0)
        ]))
        # Standard Trim (75x75)
        trim = Part.makeFace(Part.makePolygon([
            FreeCAD.Vector(-12,-12,0), FreeCAD.Vector(62,-12,0), 
            FreeCAD.Vector(62,62,0), FreeCAD.Vector(-12,62,0), FreeCAD.Vector(-12,-12,0)
        ]))
        return border, trim
    ...
    def test00_categorization(self):
        ...
        self.assertEqual(step_10[0][1], "Mixed", "Pocket floor at Z=10 should be categorized as Mixed")
