...
import Path.Op.SurfaceExp as PathSurfaceExp
...
class TestSurfaceExpOp(PathTestWithAssets):
    ...
    def setUp(self):
        super().setUp()
        self.doc = FreeCAD.newDocument("TestSurfaceExp")
    ...
    def test00(self):
        ...
        INPUT:
        - Function: PathSurfaceExp.ObjectSurface()
    ...
    def test01(self):
        ...
        INPUT:
        - Function: ObjectSurfaceExp.propertyEnumerations()
        ...
        """
        enums = PathSurfaceExp.ObjectSurface.propertyEnumerations()
    ...
    def test04(self):
        ...
        proxy = PathSurfaceExp.ObjectSurface.__new__(PathSurfaceExp.ObjectSurface)
