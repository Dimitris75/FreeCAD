...
__title__ = "CAM SurfaceExp 3D Operation UI"
...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = FreeCADGui.PySideUic.loadUi(":/panels/PageOpSurfaceExpEdit.ui")
        comboToPropertyMap = [
        ...
        enumTups = PathSurfaceExp.ObjectSurface.propertyEnumerations(dataType="raw")
...
FreeCAD.Console.PrintLog("Loading PathSurfaceExpGui... done\n")
